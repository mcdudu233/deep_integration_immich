...
function assertStaticAdminGuardrails() {
    ...
    assertIncludes(authHandoffController, 'sharedParentDomainCookie((string)$session[\'setCookie\'], $redirectUrl)', 'Open Immich controller must rewrite cookies only through the shared-parent-domain guard')
